...
Developing [models](https://github.com/stfc/goldilocks_kpoints) and a [web-app](https://github.com/stfc/goldilocks) for the prediction of the k-points density for SCF single point energy calculations with Quantum Espresso. We also did some work on LLMs, testing them for input file generation for different compounds as it is, prompting with input file schema and compound information, and fine-tuning small LLMs on input files, [link](https://github.com/ddmms/LLM-DFT-input-generation/).
